...
def profile_code(script_name):
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            txt_file = f'/reports/profiling_results_{script_name}_{current_date}.txt'
            ...
            with open(txt_file, 'w') as f:
                ...
                f.write('Line #    Time (ms)    Hits    Per Hit (ms)    % Time    Line Contents\n')
                f.write('=' * 80 + '\n')
                ...
                for key, stat in stats.timings.items():
                    ...
                    func_name = key[2]
                    func_code = key[0]
                    if inspect.isfunction(func_code) or inspect.ismethod(func_code):
                        ...
                        for line_no, nhits, time in stat:
                            ...
                            f.write(f'{line_no:6d}    {time / 1000:.2f}    {nhits:6d}    {time / nhits / 1000:.2f}    {time / total_time * 100:8.2f}    {line_content}\n')
